              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-header">Rice Monitoring</li>
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=rice/drone" class="nav-link nav-rice/drone">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          Drone Detect
                        </p>
                    ...
                    <li class="nav-item dropdown">
                    <a href="<?php echo base_url ?>admin/?page=rice/pest" class="nav-link nav-rice/pest">
                        <i class="nav-icon fas fa-cogs"></i>
                        <p>
                          Pest Detection
                        </p>
                    ...
                    <li class="nav-item dropdown">
                    <a href="<?php echo base_url ?>admin/?page=rice/disease" class="nav-link nav-rice/disease">
                        <i class="nav-icon fas fa-cogs"></i>
                        <p>
                          Disease Detection
                        </p>
                    ...
                    <li class="nav-item dropdown">
                    <a href="<?php echo base_url ?>admin/?page=rice/library" class="nav-link nav-rice/library">
                        <i class="nav-icon fas fa-cogs"></i>
                        <p>
                          Library
                        </p>
